...
AI_Usage_analysis/
    ...
    README.md                  # This file
## 📊 Power BI Dashboard
An interactive dashboard was built to visually explore the key findings:

![Dashboard Preview](dashboard_preview.png)

**Visualizations included:**
- **Overall average improvement:** +10.00 points
- **By AI tool:** Gemini (+10.84) > Copilot (+10.00) > ChatGPT (+8.62)
- **By purpose:** Research, Coding, and Homework show significant improvements
- **AI usage by age:** Between 25-50% depending on the age group
## 📚 Data Source & License
